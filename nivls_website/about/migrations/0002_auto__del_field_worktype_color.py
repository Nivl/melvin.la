...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkType.color'
        db.delete_column('about_worktype', 'color')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WorkType.color'
        raise RuntimeError("Cannot reverse this migration. 'WorkType.color' and its values cannot be restored.")
