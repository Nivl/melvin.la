...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blog_post', 'main_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Post.main_image'
        raise RuntimeError("Cannot reverse this migration. 'Post.main_image' and its values cannot be restored.")
