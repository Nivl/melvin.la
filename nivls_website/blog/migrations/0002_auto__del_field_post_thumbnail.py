...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Post.thumbnail'
        raise RuntimeError("Cannot reverse this migration. 'Post.thumbnail' and its values cannot be restored.")
