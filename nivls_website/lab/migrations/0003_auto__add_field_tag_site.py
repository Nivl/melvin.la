...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.site'
        db.add_column('lab_tag', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='labtag_set', to=orm['commons.I18nSite']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.site'
        db.delete_column('lab_tag', 'site_id')
    ...
    models = {
        ...
        'lab.tag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'labtag_set'", 'to': "orm['commons.I18nSite']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'})
        },
        'lab.todo': {
