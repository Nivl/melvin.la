...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.init = function(){
			...
			// NIVL
			  base.$controls = $('.anythingControls')
			  base.$nav = $('.thumbNav')
			/*  
		...
		base.updateSlider = function(){
			...
			base.$controls
				.add(base.$nav)[(base.pages <= 1) ? 'hide' : 'show']();
			if (base.pages > 1) {
			...
			base.$nav.find('a').eq(base.currentPage - 1).addClass('active'); // update current selection
			  ...
			  if (o.buildNavigation && (base.pages > 1)) {
				...
				$a.each(function(index, value){
				    var i = index+1
				      ...
				      $(this).bind(o.clickControls, function(e) {
						if (!base.flag && o.enableNavigation) {
							// prevent running functions twice (once for click, second time for focusin)
							base.flag = true; setTimeout(function(){ base.flag = false; }, 100);
							base.gotoPage(i);
							if (o.hashTags) { base.setHash(i); }
						}
						e.preventDefault();
					});
   				  });
		...
		base.setDimensions = function(){
			var w, h, c, edge = 0,
				...
				pw = 800//(o.showMultiple > 1) ? base.width || base.$window.width()/o.showMultiple : base.$window.width(),
				winw = base.$win.width();
			if (o.expand){
				w = 800//base.$outer.width() - base.outerPad[0];
				base.height = h = 490//NIVL base.$outer.height() - base.outerPad[1];
			...
			base.$items.each(function(i){
				...
				if (o.resizeContents){
					...
					w = 800//$(this).width() || base.width; // if image hasn't finished loading, width will be zero, so set it to base width instead
					if (c.length === 1 && w >= winw){
						w = (c.width() >= winw) ? pw : c.width(); // get width of solitary child
						c.css('max-width', w);   // set max width for all children
					}
					$(this).css('width', w); // set width of panel
					h = 490 //NIVL (c.length === 1 ? c.outerHeight(true) : $(this).height()); // get height after setting width
		...
		base.getDim = function(page){
			...
			var i,
				w = 800//base.panelSize[page][0],
				h = 490//base.panelSize[page][1];
			if (o.showMultiple > 1) {
				for (i=1; i < o.showMultiple; i++) {
					w = 800 //+= base.panelSize[(page + i)%o.showMultiple][0];
					h = 490//Math.max(h, base.panelSize[page + i][1]);
				}
			}
			return [w,h];
		};
		...
		base.setCurrentPage = function(page, move) {
			...
			if (o.buildNavigation){
				base.$nav
					...
					.find('a').eq(page - 1).addClass('active');
			}
