	...
	$.anythingSlider = function(el, options) {
		...
		base.setDimensions = function(){
			...
			if (o.expand){
				...
				base.height = h = 530//NIVL base.$outer.height() - base.outerPad[1];
			...
			base.$items.each(function(i){
				...
				if (o.resizeContents){
					...
					h = 530 //NIVL (c.length === 1 ? c.outerHeight(true) : $(this).height()); // get height after setting width
		...
		base.getDim = function(page){
			...
			var i,
				...
				h = 530//base.panelSize[page][1];
			if (o.showMultiple > 1) {
				for (i=1; i < o.showMultiple; i++) {
					w = 800 //+= base.panelSize[(page + i)%o.showMultiple][0];
					h = 530//Math.max(h, base.panelSize[page + i][1]);
				}
			}
			return [w,h];
		};
