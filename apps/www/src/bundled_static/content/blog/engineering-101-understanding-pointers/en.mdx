...
If you pass a variable by value to a function, the function gets a _clone_. If it changes the clone, the original is untouched.
If you pass a pointer, the function knows where the _original_ lives. It can modify the actual data.
