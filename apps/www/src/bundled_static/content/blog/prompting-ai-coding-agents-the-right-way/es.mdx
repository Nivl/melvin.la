...
Ha procesado un volumen enorme de tareas de ingeniería bien especificadas. Sabe cómo se ve una solicitud de característica completa. Sabe qué información falta típicamente en un informe de error vago. El truco es hacer que te diga qué falta _antes_ de pedirle que haga algo.
...
Comienzas con la misma oración, luego preguntas: _"Antes de empezar, ¿qué necesitarías saber para implementar esto correctamente? ¿Qué debería aclarar?"_
...
Imagina que alguien reporta un error: _"A veces, el botón de inicio de sesión no funciona"._
...
Le das al agente el reporte del error y le preguntas: _"¿Qué necesitarías saber para diagnosticar esto de manera efectiva? ¿Qué preguntas haría un ingeniero senior antes de tocar cualquier código?"_
