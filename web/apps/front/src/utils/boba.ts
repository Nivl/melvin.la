...
export type BobaCoordinate = { x: number; y: number; durationMs: number };
...
const bobaMinAnimationDuration = 1300;
const bobaMaxAnimationDuration = 2000;
...
export const defaultBobaCoordinates: BobaCoordinate[] = [
  { x: 716.945, y: 2326.95, durationMs: randomDuration() },
  { x: 874.945, y: 2171.95, durationMs: randomDuration() },
  { x: 605.945, y: 2129.95, durationMs: randomDuration() },
  { x: 1010.95, y: 2319.95, durationMs: randomDuration() },
  { x: 1253.95, y: 2211.95, durationMs: randomDuration() },
  { x: 1075.95, y: 2106.95, durationMs: randomDuration() },
  { x: 439.945, y: 2254.95, durationMs: randomDuration() },
];

// All the math is AI generated because fuck doing this
// by hand.
//
...
// - When updating a single ball, it should not overlap with its previous position and should be at least 1 SD away
function validSpot(
  x: number,
  y: number,
  ignore: number,
