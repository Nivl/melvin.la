...
Si pasas una variable por valor a una función, la función obtiene un _clon_. Si cambia el clon, el original queda intacto.
Si pasas un puntero, la función sabe dónde vive el _original_. Puede modificar los datos reales.
