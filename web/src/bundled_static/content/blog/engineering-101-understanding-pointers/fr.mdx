...
Si vous passez une variable par valeur à une fonction, la fonction reçoit un _clone_. Si elle modifie le clone, l'original reste intact.
Si vous passez un pointeur, la fonction sait où vit l'_original_. Elle peut modifier les données réelles.
