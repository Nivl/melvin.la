...
export const Header = () => {
  ...
  return (
    <header className="flex w-full flex-col">
      <Heading
        level={1}
        className="border-b-foreground font-condensed-latin leading-tight-xs sm:leading-tight-sm xl:leading-tight-xl mx-auto inline-flex w-full items-center justify-center pt-0 pb-8 text-6xl font-normal sm:w-auto sm:px-16 sm:pb-4 sm:text-8xl xl:px-28 xl:pb-8 xl:text-9xl"
      >
