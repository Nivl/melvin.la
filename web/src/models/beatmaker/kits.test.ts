...
test('getSampleUrl returns versioned path with correct extension', () => {
  expect(getSampleUrl('808', 'kick')).toBe(
    '/assets/games/beatmaker/samples/v1/808/kick.mp3',
  );
  expect(getSampleUrl('lofi', 'ride')).toBe(
    '/assets/games/beatmaker/samples/v1/lofi/ride.mp3',
  );
});
